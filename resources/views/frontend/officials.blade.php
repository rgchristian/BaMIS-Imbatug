...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4">
            @foreach ($page_barangay_officials as $page_official)
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{ asset($page_official->photo) }}" alt="{{ $page_official->name }}">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>{{ $page_official->name }}</h5>
                            <p class="text-primary">{{ $page_official->position }}</p>
