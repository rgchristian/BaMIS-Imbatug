...
<div class="page-content">
    ...
    <form id="myForm" method="POST" action="{{ route('update.purok.nine.resident', ['id' => $edit_purok_nine_resident->id]) }}" class="forms-sample" enctype="multipart/form-data">
        @csrf

        <input type="hidden" name="id" value="{{ $edit_purok_nine_resident->id }}">
    ...
    <div class="resident-image add-photo-container" style="width: 300px; height: 300px; overflow: hidden; border-radius: 50%;">
        <div class="d-flex justify-content-center" style="width: 100%; height: 100%; border-radius: 50%; overflow: hidden;">
            ...
            <img class="rounded-circle changed-image" id="photoImage" name="photo" src="{{ asset($edit_purok_nine_resident->photo) }}" alt="{{ $edit_purok_nine_resident->photo }}" style="object-fit: cover; width: 100%; height: 100%; border-radius: 50%;" onclick="openFileBrowser()">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ $edit_purok_nine_resident->name }}">
                                </div>
                            </div>
                            <!-- Col -->
                            <!-- <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="first_name" class="form-control" value="{{ $edit_purok_nine_resident->first_name }}">
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="middle_name" class="form-control" value="{{ $edit_purok_nine_resident->middle_name }}">
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="last_name" class="form-control" value="{{ $edit_purok_nine_resident->last_name }}">
                                </div>
                            </div>
                            <!-- Col -->
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="sex" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Male" {{ $edit_purok_nine_resident->sex == 'Male' ? 'selected' : '' }}>Male</option>
                                        <option value="Female" {{ $edit_purok_nine_resident->sex == 'Female' ? 'selected' : '' }}>Female</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="datetime" id="birthdate" name="birthdate" class="form-control flatpickr-input active" placeholder="Select birthdate" value="{{ old('birthdate', $edit_purok_nine_resident->birthdate) }}">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="number" name="phone" class="form-control" value="{{ $edit_purok_nine_resident->phone }}">
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="status" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Single" {{ $edit_purok_nine_resident->status == 'Single' ? 'selected' : '' }}>Single</option>
                                        <option value="Married" {{ $edit_purok_nine_resident->status == 'Married' ? 'selected' : '' }}>Married</option>
                                        <option value="Separated" {{ $edit_purok_nine_resident->status == 'Separated' ? 'selected' : '' }}>Separated</option>
                                        <option value="Cohabitation" {{ $edit_purok_nine_resident->status == 'Cohabitation' ? 'selected' : '' }}>Cohabitation</option>
                                        <option value="Widow/er" {{ $edit_purok_nine_resident->status == 'Widow/er' ? 'selected' : '' }}>Widow/er</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="" class="form-select mb-3 form-control" id="pwd-select">
                                        ...
                                        <option value="Yes" {{ $edit_purok_nine_resident->pwd == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{ $edit_purok_nine_resident->pwd == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                    <div id="pwd-details" style="display: none;">
                                        ...
                                        <select name="pwd" id="yes-pwd" class="form-select mb-3 form-control">
                                            ...
                                            <option value="Deaf or Hard of Hearing" {{ $edit_purok_nine_resident->pwd == 'Deaf or Hard of Hearing' ? 'selected' : '' }}>Deaf or Hard of Hearing</option>
                                            <option value="Intellectual Disability" {{ $edit_purok_nine_resident->pwd == 'Intellectual Disability' ? 'selected' : '' }}>Intellectual Disability</option>
                                            <option value="Learning Disability" {{ $edit_purok_nine_resident->pwd == 'Learning Disability' ? 'selected' : '' }}>Learning Disability</option>
                                            <option value="Mental Disability" {{ $edit_purok_nine_resident->pwd == 'Mental Disability' ? 'selected' : '' }}>Mental Disability</option>
                                            <option value="Physical Disability" {{ $edit_purok_nine_resident->pwd == 'Physical Disability' ? 'selected' : '' }}>Physical Disability</option>
                                            <option value="Psychosocial Disability" {{ $edit_purok_nine_resident->pwd == 'Psychosocial Disability' ? 'selected' : '' }}>Psychosocial Disability</option>
                                            <option value="Speech and Language Impairment" {{ $edit_purok_nine_resident->pwd == 'Speech and Language Impairment' ? 'selected' : '' }}>Speech and Language Impairment</option>
                                            <option value="Visual Disability" {{ $edit_purok_nine_resident->pwd == 'Visual Disability' ? 'selected' : '' }}>Visual Disability</option>
                                            <option value="Cancer" {{ $edit_purok_nine_resident->pwd == 'Cancer (RA11215)' ? 'selected' : '' }}>Cancer (RA11215)</option>
                                            <option value="Rare Disease" {{ $edit_purok_nine_resident->pwd == 'Rare Disease (RA10747)' ? 'selected' : '' }}>Rare Disease (RA10747)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="tribe" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Talaandig" {{ $edit_purok_nine_resident->tribe == 'Talaandig' ? 'selected' : '' }}>Talaandig</option>
                                        <option value="Higaonon" {{ $edit_purok_nine_resident->tribe == 'Higaonon' ? 'selected' : '' }}>Higaonon</option>
                                        <option value="Bukidnon" {{ $edit_purok_nine_resident->tribe == 'Bukidnon' ? 'selected' : '' }}>Bukidnon</option>
                                        <option value="Umayamnon" {{ $edit_purok_nine_resident->tribe == 'Umayamnon' ? 'selected' : '' }}>Umayamnon</option>
                                        <option value="Matigsalug" {{ $edit_purok_nine_resident->tribe == 'Matigsalug' ? 'selected' : '' }}>Matigsalug</option>
                                        <option value="Manobo" {{ $edit_purok_nine_resident->tribe == 'Manobo' ? 'selected' : '' }}>Manobo</option>
                                        <option value="Tigwahanon" {{ $edit_purok_nine_resident->tribe == 'Tigwahanon' ? 'selected' : '' }}>Tigwahanon</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="religion" class="form-select mb-3 form-control" id="religion-select">
                                        ...
                                        <option value="Roman Catholicism" {{ $edit_purok_nine_resident->religion == 'Roman Catholic' ? 'selected' : '' }}>Roman Catholic</option>
                                        <option value="Islam" {{ $edit_purok_nine_resident->religion == 'Islam' ? 'selected' : '' }}>Islam</option>
                                        <option value="Iglesia ni Cristo" {{ $edit_purok_nine_resident->religion == 'Iglesia ni Cristo' ? 'selected' : '' }}>Iglesia ni Cristo</option>
                                        <option value="Others" {{ $edit_purok_nine_resident->religion == 'Others' ? 'selected' : '' }}>Others</option>
                                    </select>
                                    <div class="mb-3 form-group" id="other-religion-input" style="display: none;">
                                        <label class="form-label">Specify Religion</label>
                                        <input type="text" name="religion" id="other-religion" class="form-control" value="{{ $edit_purok_nine_resident->religion }}">
                                    </div>
                                </div>
                            </div>
                            <!-- Col -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="address" class="form-control" value="{{ $edit_purok_nine_resident->address }}">
                                </div>
                            </div>
                            <!-- Col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="educational_attainment" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Some Elementary" {{ $edit_purok_nine_resident->educational_attainment == 'Some Elementary' ? 'selected' : '' }}>Some Elementary</option>
                                        <option value="Elementary Graduate" {{ $edit_purok_nine_resident->educational_attainment == 'Elementary Graduate' ? 'selected' : '' }}>Elementary Graduate</option>
                                        <option value="Some High School" {{ $edit_purok_nine_resident->educational_attainment == 'Some High School' ? 'selected' : '' }}>Some High School</option>
                                        <option value="High School Graduate" {{ $edit_purok_nine_resident->educational_attainment == 'High School Graduate' ? 'selected' : '' }}>High School Graduate</option>
                                        <option value="Some College/Vocational" {{ $edit_purok_nine_resident->educational_attainment == 'Some College/Vocational' ? 'selected' : '' }}>Some College/Vocational</option>
                                        <option value="College Graduate" {{ $edit_purok_nine_resident->educational_attainment == 'College Graduate' ? 'selected' : '' }}>College Graduate</option>
                                        <option value="Some/Completed Masters Degree" {{ $edit_purok_nine_resident->educational_attainment == 'Some/Completed Masters Degree' ? 'selected' : '' }}>Some/Completed Masters Degree</option>
                                        <option value="Masters Graduate" {{ $edit_purok_nine_resident->educational_attainment == 'Masters Graduate' ? 'selected' : '' }}>Masters Graduate</option>
                                        <option value="Vocational/TVET" {{ $edit_purok_nine_resident->educational_attainment == 'Vocational/TVET' ? 'selected' : '' }}>Vocational/TVET</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="occupation" class="form-control" value="{{ $edit_purok_nine_resident->occupation }}">
                                </div>
                            </div>
                            <!-- Col -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="number" name="relation_to_the_hh_head" class="form-control" value="{{ $edit_purok_nine_resident->relation_to_the_hh_head }}">
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="moral" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Good Conduct (No Case)" {{ $edit_purok_nine_resident->moral == 'Good Conduct (No Case)' ? 'selected' : '' }}>Good Conduct (No Case)</option>
                                        <option value="Has Unsettled Case" {{ $edit_purok_nine_resident->moral == 'Has Unsettled Case' ? 'selected' : '' }}>Has Unsettled Case</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="active_participation" class="form-select mb-3 form-control">
                                        <option value="" selected disabled>Select </option>
                                        <option value="Active" {{ $edit_purok_nine_resident->active_participation == 'Active' ? 'selected' : '' }}>Active</option>
                                        <option value="Inactive" {{ $edit_purok_nine_resident->active_participation == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
                            ...
                            <div class="col-sm-6">
                                ...
                                <label for="moral" class="form-label">
                                    ...
                                    <select name="registered_voter" class="form-select mb-3 form-control">
                                        <option value="" selected disabled>Select </option>
                                        <option value="Yes" {{ $edit_purok_nine_resident->registered_voter == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{ $edit_purok_nine_resident->registered_voter == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-6">
                                ...
                                <label for="moral" class="form-label">
                                    ...
                                    <select name="household_representative" class="form-select mb-3 form-control">
                                        <option value="" selected disabled>Select </option>
                                        <option value="Yes" {{ $edit_purok_nine_resident->household_representative == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{ $edit_purok_nine_resident->household_representative == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div><!-- Col -->
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="purok" class="form-select mb-3 form-control">
                                        ...
                                        <option value="Purok 1" {{ $edit_purok_nine_resident->purok == 'Purok 1' ? 'selected' : '' }}>Purok 1</option>
                                        <option value="Purok 2" {{ $edit_purok_nine_resident->purok == 'Purok 2' ? 'selected' : '' }}>Purok 2</option>
                                        <option value="Purok 3" {{ $edit_purok_nine_resident->purok == 'Purok 3' ? 'selected' : '' }}>Purok 3</option>
                                        <option value="Purok 4" {{ $edit_purok_nine_resident->purok == 'Purok 4' ? 'selected' : '' }}>Purok 4</option>
                                        <option value="Purok 5" {{ $edit_purok_nine_resident->purok == 'Purok 5' ? 'selected' : '' }}>Purok 5</option>
                                        <option value="Purok 6" {{ $edit_purok_nine_resident->purok == 'Purok 6' ? 'selected' : '' }}>Purok 6</option>
                                        <option value="Purok 7" {{ $edit_purok_nine_resident->purok == 'Purok 7' ? 'selected' : '' }}>Purok 7</option>
                                        <option value="Purok 8" {{ $edit_purok_nine_resident->purok == 'Purok 8' ? 'selected' : '' }}>Purok 8</option>
                                        <option value="Purok 9" {{ $edit_purok_nine_resident->purok == 'Purok 9' ? 'selected' : '' }}>Purok 9</option>
                                    </select>
                                </div>
                            </div>
                            <!-- Col -->
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="number" name="household_no" class="form-control" value="{{ $edit_purok_nine_resident->household_no }}"> 
                                </div>
                            </div>
                            <!-- Col -->
                            <!-- </div>
