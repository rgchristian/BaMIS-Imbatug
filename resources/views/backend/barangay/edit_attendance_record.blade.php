                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="attendance_date_created" name="attendance_record_date_time_created" class="form-control flatpickr-input active" value="{{ $edit_attendance_record->attendance_record_date_time_created }}" readonly="readonly">
