...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Blotter Record</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="incident_status" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="resident_phone" placeholder="Enter resident phone" class="form-control">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="resident_age" placeholder="Enter resident age" class="form-control">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="complainant_phone" placeholder="Enter complainant phone" class="form-control">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="complainant_age" placeholder="Enter complainant age" class="form-control">
                            ...
                            <div class="col-sm-6">
    							<div class="mb-3 form-group">
        							...
        							<textarea name="list_mediators" placeholder="Enter mediators names" rows="6" class="form-control"></textarea>
