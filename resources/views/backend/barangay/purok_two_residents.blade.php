...
<nav class="page-breadcrumb">
  ...
  <tr class="{{ $rowClass }}">
    ...
    @if ($barangay_purok_two_residents->household_representative == 'Yes')
        {!! DNS2D::getBarcodeSVG($barangay_purok_two_residents->qr_code, 'QRCODE', 1.7, 1.7, 'white') !!}
    @else
    ...
    <td>
      <div style="text-align: center;">
        <a href="{{ route('view.purok.two.resident', $barangay_purok_two_residents->id) }}">
        ...
        <a href="{{ route('edit.purok.two.resident', $barangay_purok_two_residents->id) }}">
        ...
        <a href="{{ route('delete.purok.two.resident', $barangay_purok_two_residents->id) }}" id="delete"> 
