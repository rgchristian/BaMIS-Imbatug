            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="datetime" id="barangay_certificate" name="date_issued"
                    ...
                    <button type="button" class="btn btn-primary submit" data-bs-toggle="tooltip"
                        data-bs-placement="right" title="Generate certificate">Generate Certificate</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- 'img src' goes here -->
                    <img src="{{ asset('upload/barangay certificate.jpg') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
