...
<nav class="page-breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Persons with Disability (PWD)</li>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Persons with Disability (PWD) Residents</h6>
                <!-- <p class="text-muted mb-3">Barangay Imbatug<a href="#"> residents</a>.</p> -->
                <p class="text-muted mb-3">Barangay Imbatug<a href="#"> persons with disability residents</a>.</p>
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table border-secondary border-top table-bordered table-hover">
                    ...
                    <tbody>
                    @foreach($pwdResidents as $key => $barangay_pwd_residents)
                   
    @php
        $hasCase = $barangay_pwd_residents->moral === 'Has Unsettled Case';
        $inactive = $barangay_pwd_residents->active_participation === 'Inactive';
        $rowClass = '';
  ...
  <tr class="{{ $rowClass }}">
    ...
    <td style="text-align: center;">{{ $barangay_pwd_residents->age }}</td>
