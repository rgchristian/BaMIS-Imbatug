  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-6 col-md-12 col-xl-5">
        <a href="{{ route('total.ethnicity') }}" class="img-link">
          <img src="{{ asset('upload/ethnicity.png') }}" alt="Ethnicity Icon" class="img-fluid" width="70" height="70">
          </a>
          <div class="d-flex align-items-baseline">
          </div>
        </div>
                ...
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  ...
                  <div class="dropdown mb-2">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton4">
                      <a class="dropdown-item d-flex align-items-center" href="{{ route('barangay.attendance.records') }}"><i data-feather="eye" class="icon-sm me-2"></i> <span class="">View</span></a>
                      <a class="dropdown-item d-flex align-items-center" href="{{ route('barangay.attendance.records') }}"><i data-feather="edit-2" class="icon-sm me-2"></i> <span class="">Edit</span></a>
                      <a class="dropdown-item d-flex align-items-center" href="{{ route('barangay.attendance.records') }}"><i data-feather="trash" class="icon-sm me-2"></i> <span class="">Delete</span></a>
                      <!-- <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i data-feather="printer" class="icon-sm me-2"></i> <span class="">Print</span></a>
                      <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i data-feather="download" class="icon-sm me-2"></i> <span class="">Download</span></a> -->
                    </div>
                  </div>
    ...
    <thead>
        <tr>
            ...
            <th class="pt-0" style="text-align: center;">Event Name</th>
            <th class="pt-0" style="text-align: center;">Event Location</th>
            <th class="pt-0" style="text-align: center;">Event Date</th>
        </tr>
    </thead>
    <tbody>
        @foreach($attendance_records as $key => $dash_attendance)
        <tr>
            <td style="text-align: center;">{{ $key+1 }}</td>
            <td style="text-align: center;">{{ $dash_attendance->event_name }}</td>
            <td style="text-align: center;">{{ $dash_attendance->event_location }}</td>
            <td style="text-align: center;">{{ date('Y-m-d H:i', strtotime($dash_attendance->event_date_time)) }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
